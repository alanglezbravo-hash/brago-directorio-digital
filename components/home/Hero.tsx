    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 w-full max-w-5xl mx-auto pt-32 pb-24">
        ...
        <motion.p
          ...
          className="font-serif italic text-lg lg:text-2xl text-brago-cream/55 mb-5 font-light tracking-wide max-w-2xl"
        >
          La guía editorial de real estate, hospitalidad, cultura,<br className="hidden lg:block" /> inversión y estilo de vida que define el nuevo Bajío.
        </motion.p>
        ...
        <motion.p
          ...
          className="text-xs tracking-widest-2 uppercase text-brago-gold/70 mb-14 font-medium"
        >
          No todo aparece en BRAGO. Solo lo que merece ser visto.
        </motion.p>
        ...
        >
          <Link
            href="/directorio?ciudad=San Miguel de Allende"
          ...
          >
            <span className="text-2xs tracking-widest uppercase font-medium">Explorar San Miguel</span>
            <span className="text-brago-cream/30 group-hover:text-brago-gold/50 transition-colors">→</span>
          </Link>
          <Link
            href="/directorio?ciudad=León"
            className="group flex items-center gap-3 px-7 py-3.5 border border-brago-cream/20 text-brago-cream hover:border-brago-gold/60 hover:text-brago-gold transition-all duration-400"
          >
            <span className="text-2xs tracking-widest uppercase font-medium">Explorar León</span>
            <span className="text-brago-cream/30 group-hover:text-brago-gold/50 transition-colors">→</span>
          </Link>
          <Link
            href="/membresias"
        ...
        >
          <input
            type="text"
            placeholder="Buscar restaurantes, colonias, hoteles, propiedades, experiencias…"
            readOnly
            onClick={() => window.location.href = '/directorio'}
            className="w-full bg-brago-black/50 backdrop-blur-md border border-brago-cream/15 text-brago-cream placeholder:text-brago-cream/30 px-6 py-4 text-xs font-light focus:outline-none focus:border-brago-gold/40 transition-colors duration-400 cursor-pointer"
          />
          <div className="absolute right-4 top-1/2 -translate-y-1/2 text-brago-cream/30">
